        ...
        <form @submit.prevent="submit">
          <div class="space-y-5 bg-white px-10 py-10 shadow-2xl rounded-lg">
            ...
            <div class="space-y-5" v-if="formStep == 1">
              <div class="flex flex-col space-y-2">
                ...
                <input type="text" id="fullname" placeholder="Enter your fullname"
                  class="text-xs placeholder:placeholder:text-gray-700 py-4" v-model="form.name" />
              </div>

              <div class="flex flex-col space-y-2">
                <label for="email" class="form-label">Email</label>
                <input type="email" id="email" placeholder="Enter your school email"
                  class="text-xs placeholder:text-gray-700 py-4" v-model="form.email" />
              </div>

              <div class="flex flex-col space-y-2">
                <label for="personal-number" class="form-label">Phonenumber</label>
                <input type="text" id="personal-number" placeholder="Enter your phonenumber"
                  class="text-xs placeholder:text-gray-700 py-4" v-model="form.phone_number" />
              </div>

              <div class="flex flex-col space-y-2">
                <label for="personal-number" class="form-label">Next of Kin #</label>
                <input type="text" id="personal-number" placeholder="Enter your next of kin phonenumber"
                  class="text-xs placeholder:text-gray-700 py-4" v-model="form.next_of_kin" />
              </div>
            </div>
            ...
            <div class="space-y-5" v-if="formStep == 2">
              <div class="flex flex-col space-y-2">
                <label for="personal-number" class="form-label">Registration Number</label>
                <input type="text" id="personal-number" placeholder="Enter your reg number"
                  class="text-xs placeholder:text-gray-700 py-4" v-model="form.reg_number" />
              </div>

              <div class="flex flex-col space-y-2">
                <label for="program" class="form-label">Program of Study</label>
                <select v-model="form.program_of_study" id="program-select">
                  <option v-for="programme in programmes.data" :key="programme.id" :value="programme.id">
                    {{ programme.name }}
                  </option>
                </select>
              </div>
              ...
              <div class="flex flex-col">
                ...
                <input type="file" class="file-style" @input="form.profile_pic = $event.target.files[0]"
                  accept=".jpg, .png, .jpeg" />
              ...
              <div class="flex flex-col space-y-2">
                ...
                <div class="flex space-x-4">
                  <div class="space-x-2">
                    <input type="radio" id="male" v-model="form.gender" value="M" checked />
                    <label for="male">Male</label>
                  </div>

                  <div class="space-x-2">
                    <input id="female" type="radio" v-model="form.gender" value="F" />
            ...
            <div class="space-y-5" v-if="formStep == 3">
              <div class="flex flex-col space-y-2">
                ...
                <select id="program-select" v-model="form.district">
                  <option v-for="(district, index) in districts.data" :key="index" :value="district.id">
                    {{ district.name }}
                  </option>
                </select>
              </div>
              ...
              <div class="flex flex-col space-y-2">
                ...
                <input type="password" id="password" placeholder="Enter Password"
                  class="text-xs placeholder:text-gray-700 py-4" v-model="form.password" />
              </div>

              <div class="flex flex-col space-y-2">
                <label for="confirm-password" class="form-label">Confirm Password</label>
                <input type="password" id="confirm-password" placeholder="Confirm Password"
                  class="text-xs placeholder:text-gray-700 py-4" v-model="form.password_confirmation" />
              </div>
            </div>
            ...
            <div v-if="formStep == 3" class="flex justify-between">
              ...
              <button class="bg-veryDarkBlue text-white px-4 py-3 rounded" type="submit" @click="submit">
                Submit
              </button>
            </div>
          </div>
